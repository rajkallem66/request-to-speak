define(["classie"], function(classie) {
    ...
    let animEndEventName = "animationend";
    ...
    FForm.prototype._initEvents = function() {
        ...
        this.fields.forEach( function( fld ) {
            if( fld.hasAttribute( "data-input-trigger" ) ) {
                let input = fld.querySelector( "input[type=\"radio\"]" ) || /* fld.querySelector( '.cs-select' ) ||*/ fld.querySelector( "select" ); // assuming only radio and select elements (TODO: exclude multiple selects)
                if( !input ) return;
    ...
    FForm.prototype._nextField = function( backto ) {
		...
		// current field
        let currentFld = this.fields[this.current];
    ...
    FForm.prototype._validade = function() {
        ...
        let input = fld.querySelector( "input[required]" ) || fld.querySelector( "textarea[required]" ) || fld.querySelector( "select[required]" );
        let error;
